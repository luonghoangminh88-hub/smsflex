...
import { LayoutDashboard, Users, Phone, Globe, Settings, LogOut, Wallet, CreditCard, Shield } from "lucide-react"
...
const navItems = [
  ...
  { href: "/admin/security-monitor", icon: Shield, label: "Bảo mật" },
